...
!(__WEBPACK_AMD_DEFINE_RESULT__ = (function (require) {
    ...
    var serializeWithStyles = __webpack_require__(256);
    ...
    if (!encoder) {
        encoder = __webpack_require__(257).encode;
    }
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(258)(module), __webpack_require__(259)))
...
!(__WEBPACK_AMD_DEFINE_RESULT__ = (function (require) {
    ...
    var d3Collection = __webpack_require__(115);
    ...
    return function module() {
        ...
        function buildAxis() {
            if (isHorizontal) {
                xAxis = d3Axis.axisBottom(xScale).ticks(xTicks).tickFormat(getFormattedValue);
                yAxis = d3Axis.axisLeft(yScale);
            } else {
                xAxis = d3Axis.axisBottom(xScale);
                yAxis = d3Axis.axisLeft(yScale).ticks(yTicks).tickFormat(getFormattedValue);
            }
        }
