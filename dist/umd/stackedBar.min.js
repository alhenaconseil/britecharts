...
!(__WEBPACK_AMD_DEFINE_RESULT__ = function (require) {
    ...
    return function module() {
        ...
        function getNearestDataPoint(mouseX) {
            ...
            var dataByValueParsed = transformedData.map(function (item) {
                item.key = item.key;
                return item;
            });

            var nearest = dataByValueParsed.find(function (_ref3) {
                var key = _ref3.key;
        ...
        function getNearestDataPoint2(mouseY) {
            ...
            var nearest = dataByValueParsed.find(function (_ref4) {
                var key = _ref4.key;
