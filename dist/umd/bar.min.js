...
!(__WEBPACK_AMD_DEFINE_RESULT__ = (function (require) {
    ...
    return function module() {
        ...
        function drawLabels() {
            ...
            var labels = svg.select('.metadata-group').append('g').classed('percentage-label-group', true).selectAll('text').data(data.reverse()).enter().append('text');

            labels.classed('percentage-label', true).attr('x', labelXPosition).attr('y', labelYPosition).text(text).attr('font-size', labelsSize + 'px');
        }
