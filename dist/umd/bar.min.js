...
!(__WEBPACK_AMD_DEFINE_RESULT__ = function (require) {
    ...
    return function module() {
        ...
        getName = function getName(_ref) {
            ...
            _labelsFormatValue = function _labelsFormatValue(_ref3) {
            var value = _ref3.value;
            return d3Format.format(labelsNumberFormat)(value);
        },
            _labelsHorizontalX = function _labelsHorizontalX(_ref4) {
            var value = _ref4.value;
            return xScale(value) + labelsMargin;
        },
            _labelsHorizontalY = function _labelsHorizontalY(_ref5) {
            var name = _ref5.name;
            return yScale(name) + yScale.bandwidth() / 2 + labelsSize * (3 / 8);
        },
            _labelsVerticalX = function _labelsVerticalX(_ref6) {
            var name = _ref6.name;
            return xScale(name);
        },
            _labelsVerticalY = function _labelsVerticalY(_ref7) {
        ...
        function drawHorizontalBars(bars) {
            ...
            }).merge(bars).attr('x', 0).attr('y', function (_ref12) {
                var name = _ref12.name;
                return yScale(name);
            }).attr('height', yScale.bandwidth()).attr('width', function (_ref13) {
                var value = _ref13.value;
                return xScale(value);
            }).attr('fill', function (_ref14) {
        ...
        function drawAnimatedHorizontalBars(bars) {
            // Enter + Update
            bars.enter().append('rect').classed('bar', true).attr('x', 0).attr('y', chartHeight).attr('height', yScale.bandwidth()).attr('width', function (_ref15) {
            ...
            bars.attr('x', 0).attr('y', function (_ref16) {
                var name = _ref16.name;
                return yScale(name);
            }).attr('height', yScale.bandwidth()).attr('fill', function (_ref17) {
                var name = _ref17.name;
                return colorMap(name);
            }).transition().duration(animationDuration).delay(interBarDelay).ease(ease).attr('width', function (_ref18) {
        ...
        function drawAnimatedVerticalBars(bars) {
            // Enter + Update
            bars.enter().append('rect').classed('bar', true).attr('x', chartWidth).attr('y', function (_ref19) {
                var value = _ref19.value;
                return yScale(value);
            }).attr('width', xScale.bandwidth()).attr('height', function (_ref20) {
                ...
                return xScale(name);
            }).attr('width', xScale.bandwidth()).attr('fill', function (_ref22) {
                var name = _ref22.name;
                return colorMap(name);
            }).transition().duration(animationDuration).delay(interBarDelay).ease(ease).attr('y', function (_ref23) {
                var value = _ref23.value;
                return yScale(value);
            }).attr('height', function (_ref24) {
        ...
        function drawVerticalBars(bars) {
            // Enter + Update
            bars.enter().append('rect').classed('bar', true).attr('x', chartWidth).attr('y', function (_ref25) {
                var value = _ref25.value;
                return yScale(value);
            }).attr('width', xScale.bandwidth()).attr('height', function (_ref26) {
        ...
        function handleMouseOver(e, d, chartWidth, chartHeight) {
            ...
            d3Selection.select(e).attr('fill', function (_ref31) {
